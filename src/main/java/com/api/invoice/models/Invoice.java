...
public class Invoice {
    ...
    public Invoice(Double discount, String number, String dueDate, String invoiceDate, Double subtotal, Double VAT, Double total, String currency, Binary image, Vendor vendor, List<Line> lines) {
        this.image = image;
        this.id = UUID.randomUUID().toString();
        this.number = number;
